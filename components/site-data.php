<?php
  ...
  $site_title = "Arvestustöö";
   $site_title_lisa = "Lisaülesanne";
   
   $lisa = "Üllatustekst lisaülesandeks. Lorem ipsum jne";

  $menu_main = array("Avaleht" => "index.php", "Uudised" => "news.php", "Meeskond" => "team.php", "Harjutused" => "exercises.php",  "Lisa" => "bonus.php");
